...
const Contact: React.FC = () => {
  ...
  const notifySentForm: React.FormEventHandler<HTMLFormElement> = async (e) => {
    ...
    try {
      ...
      if (language === "NE") {
        toast.success(toastMessages.successEmailSent.ne);
      } else {
      ...
      console.log(error);
      if (language === "NE") {
        toast.error(toastMessages.failedEmailSent.ne);
      } else {
        ...
        >
          ...
          >
            <p className="text-[--black] mb-6">
              ...
              {language === "NE" ? contactData.title.ne : contactData.title.en}
              <span className="text-[--orange]">/&gt;</span>
            </p>

            <h2 className="text-[--black] text-center">
              {language === "NE"
                ? contactData.description.ne
        ...
        <div className="flex flex-row justify-center items-start px-32 pt-32 mb-32 max-lg:flex-col max-lg:p-10">
          ...
          >
            ...
            <textarea
              ...
              placeholder={
                language === "NE"
                  ? `${contactData.textarea.placeholder.ne}`
            ...
            <div className="privacy-checkbox flex gap-16">
              ...
              <p>
                {language === "NE"
                  ? `${contactData.privacyOptIn.checkbox.ne}`
                  : `${contactData.privacyOptIn.checkbox.en}`}
              </p>
            </div>
            <p>
              {language === "NE"
                ? `${contactData.privacyOptIn.description.ne}`
                : `${contactData.privacyOptIn.description.en}`}
            </p>
            <Button
              value={
                language === "NE"
                  ? `${contactData.button.value.ne}`
